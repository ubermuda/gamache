...
| PHPStan | Rules for controllers, CQRS commands, forms, templates, routes, entities, translations, security | [docs/phpstan-rules.md](docs/phpstan-rules.md) |
| PHP-CS-Fixer | 2 custom fixers for attribute formatting | [docs/php-cs-fixer.md](docs/php-cs-fixer.md) |
| Twig-CS-Fixer | Custom rules for templates | [docs/twig-cs-fixer.md](docs/twig-cs-fixer.md) |
...
This registers all rules at once. A `gamache` parameter block controls the configurable rules:
